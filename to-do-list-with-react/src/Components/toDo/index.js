            ...
            <ul className="list">
                {
                    filteredTodos.map((item, key) =>
                        <li key={key} className="item"><input type="checkbox" className="checkbox" checked={item.done} onChange={checkboxChanged} />
                            <span className={item.done ? "done" : null}>{item.tododesc}</span>
                        </li>
                    )
                }
            </ul>
